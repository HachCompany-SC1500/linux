...
static const unsigned short normal_i2c[] = {
	0x1b , 0x1a, I2C_CLIENT_END };

static struct snd_soc_codec *tlv320aic23_codec;
...
static const struct snd_kcontrol_new tlv320aic23_snd_controls[] = {
	...
	SOC_SINGLE("DAC Left/Right Swap", TLV320AIC23_DIGT_FMT, 5, 1, 0),
 ...
 */
static int tlv320aic23_register(struct aic23 *aic23)
{
	struct snd_soc_codec *codec = &aic23->codec;
	int ret = 0;
	u16 reg;

	if (tlv320aic23_codec) {
		dev_err(codec->dev, "Another TLV320AIC23 is registered\n");
		return -EINVAL;
	}
	...
	snd_soc_codec_set_drvdata(codec, aic23);
...
// The codec SSM2518 needs a low level for enabling.
	gpio_request_one(GPIO_PTD3, GPIOF_OUT_INIT_LOW, "en-sound"); // for boards with tlv320aic23 support
	gpio_free(GPIO_PTD3);
	...
	tlv320aic23_dai.dev = codec->dev;
	
	tlv320aic23_codec = codec;
	...
	ret = snd_soc_register_dai(&tlv320aic23_dai);
	if ( ret != 0 ) {
...
static __devexit tlv320aic23_unregister(struct aic23 *aic23)
{
	snd_soc_unregister_dai(&tlv320aic23_dai);
	snd_soc_unregister_codec(&aic23->codec);
	kfree(aic23);
	tlv320aic23_codec = NULL;
	return 0;
} 
 
 
static __devinit int tlv320aic23_i2c_probe(struct i2c_client *i2c,
				   const struct i2c_device_id *i2c_id)
{
	...
	return tlv320aic23_register(aic23);
}

static int __exit tlv320aic23_i2c_remove(struct i2c_client *i2c)
{
	struct aic23 *aic23 = i2c_get_clientdata(i2c);
	
	tlv320aic23_unregister(aic23);
	return 0;
}
...
static struct i2c_driver tlv320aic23_i2c_driver = {
	...
	.remove = __devexit_p(tlv320aic23_i2c_remove),
...
static int tlv320aic23_probe(struct platform_device *pdev)
{
	...
	if (tlv320aic23_codec == NULL) {
		dev_err(&pdev->dev, "Codec device not registered\n");
		return -ENODEV;
	}
	
	socdev->card->codec = tlv320aic23_codec;
	codec = tlv320aic23_codec;
