...
***********************************/
#define USB_ISP1181B_DEVICES  3

#define USB_ISP1181B_CNTRL_DEVICE         0
#define USB_ISP1181B_MEASUREMENT_DEVICE   1
#define USB_ISP1181B_BULK_DEVICE          2
/**********************************************************/
...
struct file_operations usb_cntrl_fops = {
      owner:    THIS_MODULE,
      ioctl:    usbdev_ioctl,
      read:     usb_isp1181b_read_cntrl,
      poll:     usb_isp1181b_poll_cntrl,
...
struct file_operations usb_measurement_fops = {
      owner:    THIS_MODULE,
      ioctl:    usbdev_ioctl,
      read:     usb_isp1181b_read_bulk,
      write:    usb_isp1181b_write_measurement,
      poll:     usb_isp1181b_poll_bulk,
      release:  usbdev_release,
};
