...
static struct sh_dmae_slave_config sh7723_dmae_slaves[] = {
	{
		.slave_id	= SHDMA_SLAVE_SIUA_TX,
		.addr		= 0xa454c098,
		.chcr		= DM_FIX | SM_INC | 0x800 | TS_INDEX2VAL(XMIT_SZ_32BIT) | LCKN,
		.mid_rid	= 0xb1,
	}, {
		.slave_id	= SHDMA_SLAVE_SIUA_RX,
		.addr		= 0xa454c090,
		.chcr		= DM_INC | SM_FIX | 0x800 | TS_INDEX2VAL(XMIT_SZ_32BIT) | LCKN,
		.mid_rid	= 0xb2,
	}, {
		...
		.addr		= 0x04ce0030,
		.chcr		= DM_FIX | SM_INC | 0x800 | TS_INDEX2VAL(XMIT_SZ_16BIT) | LCKN,
		.mid_rid	= 0xc1,
	}, {
		.slave_id	= SHDMA_SLAVE_SDHI0_RX,
		.addr		= 0x04ce0030,
		.chcr		= DM_INC | SM_FIX | 0x800 | TS_INDEX2VAL(XMIT_SZ_16BIT) | LCKN,
		.mid_rid	= 0xc2,
	}, {
...
/* DMA */
static struct sh_dmae_channel sh7723_dmae0_channels[] = {
	{
		.offset = 0,
		.dmars = 0,
		.dmars_bit = 0,
...
static struct sh_dmae_channel sh7723_dmae1_channels[] = {
	{
		.offset = 0,
		.dmars = 0,
		.dmars_bit = 0,
...
static struct sh_dmae_pdata dma0_platform_data = {
	.slave		= sh7723_dmae_slaves,
	.slave_num	= ARRAY_SIZE(sh7723_dmae_slaves),
	.channel	= sh7723_dmae0_channels,
	.channel_num	= ARRAY_SIZE(sh7723_dmae0_channels),
...
static struct sh_dmae_pdata dma1_platform_data = {
	.channel	= sh7723_dmae1_channels,
	.channel_num	= ARRAY_SIZE(sh7723_dmae1_channels),
	.ts_low_shift	= CHCR_TS_LOW_SHIFT,
	.ts_low_mask	= CHCR_TS_LOW_MASK,
	.ts_high_shift	= CHCR_TS_HIGH_SHIFT,
	.ts_high_mask	= CHCR_TS_HIGH_MASK,
...
static struct resource sh7723_dmae0_resources[] = {
	{
...
/* Resource order important! */
static struct resource sh7723_dmae1_resources[] = {
	{
		/* Channel registers and DMAOR */
		.start	= 0xfdc08020,
		.end	= 0xfdc0808f,
...
static struct platform_device dma0_device = {
	.name		= "sh-dma-engine",
	.id		= 0,
	.resource	= sh7723_dmae0_resources,
	.num_resources	= ARRAY_SIZE(sh7723_dmae0_resources),
	.dev		= {
...
static struct platform_device dma1_device = {
	.name		= "sh-dma-engine",
	.id		= 1,
	.resource	= sh7723_dmae1_resources,
	.num_resources	= ARRAY_SIZE(sh7723_dmae1_resources),
	.dev		= {
...
static struct resource sh4a_wdt_resources[] = {
	[0] = {
		.start	= 0xa4520000,
		.end	= 0xa4520007,
		.flags	= IORESOURCE_MEM,
...
static struct platform_device sh4a_wdt_device = {
	.name		= "sh4a_wdt",
	.resource	= sh4a_wdt_resources,
	.num_resources	= ARRAY_SIZE(sh4a_wdt_resources),
};
...
{
#ifdef CONFIG_SH_HICO7723
        /* shcodecs-cap(enc) and DirectFB require at least 4MB */
	platform_resource_setup_memory(&vpu_device,  "vpu",  4 << 20);
	platform_resource_setup_memory(&veu0_device, "veu0", 4 << 20);
